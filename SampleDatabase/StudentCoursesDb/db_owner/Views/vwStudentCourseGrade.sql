...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'db_owner', @level1type = N'VIEW', @level1name = N'vwStudentCourseGrade';
